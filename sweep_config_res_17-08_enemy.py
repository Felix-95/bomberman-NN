sweep_config = {
    ...
    'parameters': {
        ...
        'n_rounds': {
            'value': 2000  # Anzahl der Runden je Run
            # 2500 
        },
        ...
        'randomnes_rule_based_agent': {
            'values': [0.8]  # Wahrscheinlichkeit, dass RBA Aktion ausgewählt wird und nicht random
        },
        'run_quantity': {
        ...
        'agent_2': {
            'value': 'rule_based_agent'  # Optionaler Agent 2
            # 'value': ''  # Optionaler Agent 2
        },
        'agent_3': {
            'value': 'rule_based_agent'  # Optionaler Agent 3 (leer, falls nicht gesetzt)
            # 'value': ''  # Optionaler Agent 2
        },
        'agent_4': {
            'value': 'rule_based_agent'  # Optionaler Agent 4 (leer, falls nicht gesetzt)
            # 'value': ''  # Optionaler Agent 2
        },
...
## rewards 
    ...
    # 'BOMB_EXPLODED_AND_DIDNT_KILLED_SELF_YET': {
    #     'values': [5]
    # },
    # self actions
    'WAITED': {
    ...
    'lr_patience': { 'values': [200] },
    'min_lr': {'values': [0.00005]},  # Minimum learning rate
    'lr': {'values': [0.0005]},  # Learning rate range
    'EPS_START': {'values': [0.6]},  # Exploration end
    'EPS_DECAY': {'values': [0.998]},  # Exploration end
