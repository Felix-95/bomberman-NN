sweep_config = {
    ...
    'parameters': {
        # run parameters
        'map': {
            'value': 'loot-crate-easy'  # Fixierte Map für diesen Sweep
        },
        'n_rounds': {
            'value': 200  # Anzahl der Runden je Run
            # 2500 
        },
...
## rewards 
    ...
    'lr_patience': { 'values': [280] },
    'min_lr': {'values': [0.00005]},  # Minimum learning rate
    'lr': {'values': [0.0005]},  # Learning rate range
    'EPS_START': {'values': [1]},  # Exploration end
    'EPS_DECAY': {'values': [0.9995]},  # Exploration end
